...
public class GUIHelper {
    ...
    public static final String BUTON_TEXT_LIST_STREAMS = "Show me some tracks";
    public static final String BUTON_TEXT_CLEAR_STREAMS = "Clear";
    public static final String BUTON_REGISTER_USER_EXISTS = "User already exists";
    public static final String BUTON_TEXT_RECOMMEND = "Recommend";
    public static final String BUTON_TEXT_SURPRISE = "Surprise";
